...
namespace CurrencyConverterApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double amountInInr = usdToInrConverter.ConvertAmount(15); 
            Console.WriteLine($"15 USD to INR using default rate: {amountInInr} INR");
            ...
            double amountInUsd = eurToUsdConverter.ConvertAmount(500); 
            Console.WriteLine($"500 EUR to USD using default rate: {amountInUsd} USD");
